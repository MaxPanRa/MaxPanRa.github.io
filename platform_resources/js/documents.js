              ...
              var SNAPPED = data.val();
                ...
                const pdf = pdfRef.child(SNAPPED.nombre);
                  pdf.getDownloadURL().then((url) => { 
                    ...
                    $("#pdf_div ."+SNAPPED.tipo).append('<span class="admin_only delete" encrypted="true" onclick="RemoveChild(event);" style="color: #ab4949;margin-left: -20px;margin-top: 6px;font-size: 14px;position: absolute;display:none;"><i class="fa fa-trash"></i></span>'+
